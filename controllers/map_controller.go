...
import (
	...
	forwardv1beta1 "techsquad.rocks/api/v1beta1"
)
...
//+kubebuilder:rbac:groups=forward.techsquad.rocks,resources=maps/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=forward.techsquad.rocks,resources=maps/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the Map object against the actual cluster state, and then
